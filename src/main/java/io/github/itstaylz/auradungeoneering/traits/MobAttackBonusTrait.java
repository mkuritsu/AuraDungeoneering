...
public class MobAttackBonusTrait extends DungeoneeringTrait {
    ...
    private static final String KEY = "mythic_mob_attack_bonus";

    public MobAttackBonusTrait(JavaPlugin plugin, AuraDungeoneeringConfig config, DungeoneeringCustomContent content) {
